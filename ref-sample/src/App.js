...
class App extends Component {
  ...
  getData = async () => {
    ...
    try {
      // API 호출하고
      const response = await axios.get(`naver/v2/candles/trade:5m:t${pair}/hist?limit=288`,
      {
        headers: { 
      ...
      //const response = await fetch(`https://api-pub.bitfinex.com/v2/candles/trade:5m:t${pair}/hist?limit=288`, {mode:'cors'});
      // 데이터는 다음과 같은 형식인데,
